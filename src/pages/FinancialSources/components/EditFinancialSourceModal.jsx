...
const EditFinancialSourceModal = ({ isOpen, source, onClose, onSubmit }) => {
  ...
  // Initialize form with source data when modal opens
  useEffect(() => {
    if (source && isOpen) {
      setForm({
        name: source.name || '',
        type: source.type || 'BANK_ACCOUNT',
        colorCode: source.colorCode || '#4f46e5',
  ...
  const handleSubmit = (e) => {
    ...
    if (validateStep(currentStep)) {
      onSubmit({
        ...form,
        id: source.id // Preserve the original ID
      });
    }
  };
  ...
  return (
    <div className="fixed z-[50] inset-0 bg-black/50 backdrop-blur-[1.5px] overflow-y-auto">
              ...
              <div className="mb-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg leading-6 font-medium text-gray-900 flex items-center">
                    <TbPencil className="mr-2 h-5 w-5 text-primary-600" />
                    Edit {source.name}
                  </h3>
...
export default EditFinancialSourceModal;
