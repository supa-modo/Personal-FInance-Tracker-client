    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="space-y-4 md:space-y-5">
          {/* Auth error message */}
          {authError && (
            <div className="rounded-xl bg-red-500/10 backdrop-blur-sm p-4 border border-red-500/30 animate-pulse">
              <p className="text-sm font-medium text-red-200 flex items-center">
                <svg
