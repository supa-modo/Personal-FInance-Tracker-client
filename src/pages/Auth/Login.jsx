  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row overflow-hidden relative">
        ...
        <div className="relative w-full h-full flex flex-col justify-between p-12">
          ...
          <div className="pt-8 pl-6">
            ...
            <h2 className="text-5xl font-extrabold text-white mb-6 leading-tight max-w-3xl">
              Take control of your <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary-300 to-primary-200">financial future & assets</span>
            </h2>
            
            <p className="text-xl text-white/80 mb-10 max-w-xl">
              Access personalized insights and manage your finances with our intuitive platform designed for everyone.
            </p>
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center">
              ...
              >
                Create account <TbArrowRight className="ml-2 h-4 w-4" />
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center mt-20 lg:mt-0 p-4 sm:p-6 lg:p-8 relative z-10">
        ...
        {/* Use the enhanced login form component */}
        <LoginFormEnhanced 
          formData={formData}
          errors={errors}
        ...
        <div className="lg:hidden mt-12 space-y-6 max-w-md">
          ...
          {/* Mobile CTA */}
          <div className="hidden lg:flex text-center pt-4">
            <p className="text-white/80 mb-4">
              Don't have an account yet?
            </p>
            <button 
              onClick={navigateToRegister} 
              className="flex items-center px-5 py-2.5 bg-gradient-to-r from-primary-500 to-primary-700 hover:from-primary-400 hover:to-primary-600 text-white rounded-xl transition-all duration-300 shadow-lg shadow-primary-900/30 hover:shadow-primary-900/50 font-medium mx-auto"
            >
              Create account <TbArrowRight className="ml-2 h-4 w-4" />
            </button>
          </div>
